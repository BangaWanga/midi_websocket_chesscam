...
class Centroids:
            ...
            for x in range(8):  # loop over y-coordinate
                try:
                    ...
                    for colorNum, (lower, upper) in enumerate(self.colorBoundaries):
                        areaOfInterest = self.defineAreaOfInterest(frame, aoiHalfWidth, x, y)
    ...
    def defineAreaOfInterest(self, frame, aoiHalfWidth, x, y):
        ...
        areaOfInterest = frame[lowerY:upperY, lowerX:upperX]
